...
class Options:
    ...
    def __init__(self):
        ...
        parser.add_argument("--best-model-path", type=str, default="teacher_model_1.pth", help="Best model path to be loaded.")
        ...
        # I/O parameters
        parser.add_argument('--gt-dir', type=str, default="clear",
                            help='Ground truth directory name of the images.')
        parser.add_argument('--hazy-dir', type=str, default="haze",
