...
class TrainDatasetFromFolder(Dataset):
    def __init__(self, dataset_dir_h, dataset_dir_s, crop_size):
        ...
        self.image_filenames_s = [join(dataset_dir_s, x) for x in natsort.natsorted(listdir(dataset_dir_s))[0:520] for p
                                  in range(35) if is_image_file(x)]
...
class TestDatasetFromFolder(Dataset):
    def __init__(self, dataset_dir):
        ...
        self.h_path = dataset_dir + '/haze'  # '/hazy'  #hazy_new512
        self.s_path = dataset_dir + '/clear'  # '/clear'
...
class TestDatasetFromFolder55(Dataset):
    def __init__(self, dataset_dir):
        super(TestDatasetFromFolder55, self).__init__()
    ...
    def __getitem__(self, index):
        ...
        # return image_name, ToTensor()(h_image)

        return ToTensor()(h_image)
    def __len__(self):
        return len(self.h_filenames)
